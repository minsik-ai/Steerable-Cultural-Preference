...
class OurRewardTrainer(RewardTrainer):
    ...
    def compute_loss(
        ...
        ratio = torch.minimum(torch.exp((ref_rewards_chosen - ref_rewards_rejected) / self.beta), torch.ones_like(ref_rewards_chosen))
